...
USERS_FILE = "aaa.csv"          # path to your Users tab CSV
SERVERS_FILE = "ServerStatus.csv"  # path to your ServerStatus CSV
...
if st.button("Login"):
    if username in users_df["Username"].values:
        ...
        if password == str(row["Password"]).strip():
            ...
            user_centre = str(row["Centre"]).strip()
